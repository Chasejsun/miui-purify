...
# 搜索 Lcom/miui/networkassistant/ui/view/MainToolbarItemView;->setVisibility(I)V 可以找到诸如以下代码：
invoke-virtual {v3, v0}, Lcom/miui/networkassistant/ui/view/MainToolbarItemView;->setVisibility(I)V

# 在其上方增加以下代码（v0对应 invoke-virtual {v3, v0} 中的v0）：
sget v0, Lcom/winterssy/MiuiPurify;->VIEW_GONE:I
```
